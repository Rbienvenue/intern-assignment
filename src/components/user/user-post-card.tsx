...
import { MoreHorizontal, Edit, Trash2, Calendar, Eye, Heart, MessageSquare, EyeOff } from "lucide-react"
...
export function UserPostCard({ post, viewMode }: UserPostCardProps) {
      ...
      <Card className="hover:shadow-lg transition-shadow duration-200 overflow-hidden">
        <div className="relative w-full h-48">
          ...
          <div className="absolute top-2 left-2">
            <Badge variant={post.published ? "default" : "secondary"} className="bg-white/90">
              {post.published ? (
                <>
